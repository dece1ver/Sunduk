...
namespace Sunduk.PWA.Infrastructure.Sequences.Milling
{
    public class MillingPeckDeepDrillingSequence : PeckDeepDrillingSequence
    {
        ...
        public override string Operation => Templates.Operation.MillingPeckDeepDrilling(Machine, Material, Tool as MillingDrillingTool, Depth, StartZ, EndZ, Holes, Polar);

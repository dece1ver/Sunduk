...
namespace Sunduk.PWA.Infrastructure.Sequences.Milling
{
    public class MillingPeckDeepDrillingSequence : PeckDeepDrillingSequence
    {
        ...
        public MillingPeckDeepDrillingSequence(Machine machine, Material material, MillingDrillingTool tool, double depth, double startZ, double endZ, List<Hole> holes) 

...
namespace Sunduk.PWA.Infrastructure.Tools.Turning
{
    public class ThreadingExternalTool : ThreadingTool
    {
        ...
        {
            Util.ToolDescriptionOption.General => $"T{Position.ToolNumber()} ({Name} {Pitch} {Angle})".Replace(',', '.'),
            Util.ToolDescriptionOption.L230 => $"T{Position.ToolNumber()} ({Name} {Pitch} {Angle})".Replace(',', '.'),
            Util.ToolDescriptionOption.GoodwayLeft => $"T{Position.ToolNumber()} G54 M58 ({Name} {Pitch} {Angle})".Replace(',', '.'),
            Util.ToolDescriptionOption.GoodwayRight => $"T{Position.ToolNumber()} G55 M58 ({Name} {Pitch} {Angle})".Replace(',', '.'),

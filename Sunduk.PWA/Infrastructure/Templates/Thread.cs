...
namespace Sunduk.PWA.Infrastructure.Templates
{
    public static class Thread
    {
        ...
        public static void GetMetricValues(string template, ref string diameter, ref string pitch)
        {
        ...
        public static void GetBSPPValues(string template, ref string diameter, ref string pitch)
        {
            switch (template)
            {
                case "G1/16":
